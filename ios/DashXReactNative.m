...
RCT_EXTERN_METHOD(setIdentity:(NSString *)uid (NSString *)identityToken)
...
RCT_EXTERN_METHOD(uploadExternalAsset:(NSDictionary *)options (NSString *)externalColumnId resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
